...
```bash
hello-world-auth-face$ sam logs -n HelloEfsFunction --stack-name hello-world-auth-face --tail
```
...
```bash
hello-world-auth-face$ pip install -r tests/requirements.txt --user
# unit test
hello-world-auth-face$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
hello-world-auth-face$ AWS_SAM_STACK_NAME=<stack-name> python -m pytest tests/integration -v
```
...
```bash
aws cloudformation delete-stack --stack-name hello-world-auth-face
```
